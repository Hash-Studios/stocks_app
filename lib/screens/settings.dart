            ...
            content: Column(
              children: [
                ...
                ListTile(
                    ...
                    onTap: () {
                      Share.share(
                          'Hey check out this amazing stocks app Stonks https://github.com/LiquidatorCoder/stocks_app');
                    }),
              ],
            ),
          ),
            ...
            content: Column(
              children: [
                ListTile(
                    ...
                    onTap: () async {
                      launch("https://github.com/LiquidatorCoder/stocks_app");
                    }),
                ListTile(
                    leading: Icon(
                      Icons.wallpaper,
                    ...
                    subtitle: Text("Stonks uses Quandl API for stocks"),
                    onTap: () async {
                      launch("https://www.quandl.com/tools/api");
                    }),
                ListTile(
                    leading: Icon(
                      Icons.code,
